...
func (server *Server) deleteUser(ctx *gin.Context) {
	...
	ctx.JSON(http.StatusOK, gin.H{"message": fmt.Sprintf("User %s has been deleted", req.Username)})
}
...
type loginUserResponse struct {
	...
	RefreshTokenTokenExpiredAt time.Time    `json:"refresh_token_expired_at"`
...
func (server *Server) loginUser(ctx *gin.Context) {
	...
	rsp := loginUserResponse{
		...
		RefreshToken:               refreshToken,
		RefreshTokenTokenExpiredAt: refreshPayload.ExpiredAt,
